      ...
      <Accordion type="single" collapsible className="w-full">
        <AccordionItem value={accordionValue} className="border-none p-0">
          <AccordionTrigger className={cn(
            "group flex w-full flex-col sm:flex-row sm:items-baseline sm:justify-between gap-1 mb-1 text-left hover:no-underline p-0",
            ...
            <div className="flex-grow space-y-1.5">
                ...
                <div className="flex items-center">
                  <h3 className="text-base font-semibold text-foreground mr-2">{experience.title}</h3>
            ...
            <div className="flex items-center text-xs text-muted-foreground pt-1 sm:pt-0 shrink-0 self-start sm:self-baseline">
